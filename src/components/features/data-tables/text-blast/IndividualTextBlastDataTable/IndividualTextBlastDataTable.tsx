...
interface IndividualTextBlastDataTableProps<TData, TValue> {
  columns: ColumnDef<TData, TValue>[];
  enableGlobalFilter?: boolean;
  data: TData[];
}

export function IndividualTextBlastDataTable<TData, TValue>({
  columns,
  data,
  enableGlobalFilter = true,
}: IndividualTextBlastDataTableProps<TData, TValue>) {
